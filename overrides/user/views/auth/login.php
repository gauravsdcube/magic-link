...
use humhub\modules\magicLinkAuth\widgets\MagicLinkLoginButton;
        ...
        <div class="panel-body">
            ...
            <?php if ($showLoginForm): ?>
                ...
                <?= $model->hideRememberMe ? '' : $form->field($model, 'rememberMe')->checkbox() ?>
                    ...
                    <div class="mb-2">
                        <?= Html::submitButton(Yii::t('UserModule.auth', 'Sign in'), ['id' => 'login-button', 'data-ui-loader' => "", 'class' => 'btn btn-large btn-primary w-100']); ?>
                    </div>

                    <div class="mb-3">
                        <?= MagicLinkLoginButton::widget() ?>
                    </div>
